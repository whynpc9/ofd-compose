...
- 测试规模：document-model 13、template-compiler 17、binding-core 118（bind 61 + structure 48 + 差异表 9）、golden-corpus 27（node）/ 13（browser）、gates 20；`pnpm lint`、`pnpm typecheck`、`pnpm build`、`pnpm test`、`pnpm test:browser` 全绿。无新增依赖。
