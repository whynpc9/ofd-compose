...
实现与当前 profile 边界见 `dotnet/src/OFDCompose.PdfIrWriter/README.md`；独立读取、几何与变异门禁见 `tests/pdf-writer/README.md`。PR/review 进度见 PR #13；普通连续 ASCII 空白的高层归一验收尚待用户选择，不能宣称该项完整验收。
